...
*/
  ...
  $query_=mysqli_query($link, "SELECT `id`,`alias`,`hash`,`balance`,`time_last_active`,`lastip` FROM `players`$podm LIMIT $lima,$perPage");
  $pocet=mysqli_num_rows(mysqli_query($link, "SELECT `id` FROM `players`$podm"));

...
<br><br>
<b>Free balance:</b><br>
<big><?php $usersbal_=mysqli_fetch_array(mysqli_query($link, "SELECT SUM(`balance`) AS `sum` FROM `players`")); echo $wallet->getbalance()-$usersbal_['sum']; ?></big> <?php echo $settings['currency_sign']; ?>
</div>

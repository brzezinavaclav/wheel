      ...
      $.ajax({
        ...
        'success': function(data) {
          ...
          if (_length==0) cn_table+="<br><small><small>No pending deposits!</small></small>";
            ...
            cn_table+="<br><small><i>Each deposit takes a few minutes before adding to your account</i></small><br><br><table width=\"100%\"><tr><th style=\"border-bottom: 1px solid darkblue;\" align=\"left\">Amount</th><th style=\"border-bottom: 1px solid darkblue;\" align=\"left\">Transaction ID</th></tr>";
            for (var i=0;i<_length;i++) {
              cn_table+="<tr><td><small><b>"+data[i]['amount']+"</b> <?php echo $settings['currency_sign']; ?></small></td><td><small>"+data[i]['txid']+"</small></td></tr>";
            }
            cn_table+="</table>";
          }

...
CREATE TABLE `system` (
  ...
  `active_theme` VARCHAR(40) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Modern',
  `wheel` VARCHAR(40) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'wheel1.png',
  `description` text COLLATE utf8_unicode_ci NOT NULL,
  `deposits_last_round` datetime NOT NULL,
  `current_winner` datetime NOT NULL,
  `last_winner` int(11)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
